...
class NOMA_Simulator:
    ...
    def _init_complex_channel(self, avg_gain):
        # Fonction utilitaire pour créer un canal complexe h ~ CN(0, avg_gain)
        # Variance = avg_gain / 2
    ...
    def generate_channels_gains(self):
        ...
        # h_t = rho * h_{t-1} + sqrt(1 - rho^2) * noise
        ...
        # 3. Retourner la Puissance (Module au carré) pour le calcul SINR
        g1 = abs(self.h1_curr)**2
        g2 = abs(self.h2_curr)**2
